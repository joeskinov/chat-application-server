...
let passwordAuth = require('../../services/passport').password
let master = require('../../services/passport').master
...
let showMe = require('./controller').showMe
let update = require('./controller').update
let updatePassword = require('./controller').updatePassword
